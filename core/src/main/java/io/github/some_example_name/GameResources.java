...
public class GameResources {
    public static final Array<String> SHIP_IMG_PATHS = new Array<>(new String[]{
        "textures/ship1.png",
        "textures/ship2.png",
        "textures/ship3.png"
    });
    public static final String TRASH_IMG_PATH = "textures/trash.png";
    public static final String GOLDEN_TRASH_IMG_PATH = "textures/golden_trash.png";
    ...
    public static final String MENU_BACKGROUND_IMG_PATH = "textures/menu_background.png";
    ...
    public static final String FULL_BLACKOUT_IMG_PATH = "textures/full_blackout.png";
